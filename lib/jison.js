...
class Generator {
    constructor(grammar, opt) {
        ...
        var options = { ...grammar.options, ...opt };
        this.terms = {};
        this.operators = {};
        this.productions = [];
        this.conflicts = 0;
        ...
        if (this.DEBUG) Object.assign(this, generatorDebug); // mixin debug methods
        ...
        while(cont) {
            ...
            productions.forEach(function Follow_prod_forEach(production, k) {
                ...
                for (var i=0,t;t=production.handle[i];++i) {
                    ...
                    _Set.union(nonterminals[t].follows, set);
        ...
        // RHS
            ...
            for (var i=0,t;t=symbol[i];++i) {
                if (!this.nonterminals[t]) {
                    ...
                    _Set.union(firsts, this.nonterminals[t].first);
                }
                if (!this.nullable(t))
                    break;
            }
        ...
        while(cont) {
            ...
            for (symbol in nonterminals) {
                ...
                nonterminals[symbol].productions.forEach(function(production) {
                    _Set.union(firsts, production.first);
                });
...
LRGenerator.prototype.ItemSet = class extends _Set {
    constructor(...args) {
        super(...args);
        this.reductions = [];
        this.goes = {};
    ...
    parseTable(productions) {
        ...
        productions.forEach(function(production, i) {
            ...
            if (self.nullable(production.handle)) {
                _Set.union(tokens, self.nonterminals[production.symbol].follows);
            }
